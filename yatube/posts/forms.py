...
# Я настроил отправку электронных писем через реальный smtp Яндекса, закрыл
# все данные python-decouple, но мразотные автотесты не дают использовать
# эту библиотеку. Так что открываю, но надеюсь на твою благопорядочность))
