...
class PostModelTest(TestCase):
    ...
    # Сделал себе такую же фичу, как в примерах теории.
    def test_text_convert_to_slug(self):
        """Содержимое поля title преобразуется в slug, если slug не присвоен."""
        group = PostModelTest.test_group_1
        slug = group.slug
    ...
    def test_slug_max_length_not_exceed(self):
        """Длинный slug обрезается и не превышает max_length поля slug в
        модели."""
        group = PostModelTest.test_group_2
